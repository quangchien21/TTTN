...
#define GAS_SENSOR A0  // Chân analog đọc giá trị từ cảm biến khí gas - chân analog
...
void loop() {
  ...
  // mode Thủ công
    ...
    switch (c) {
      ...
      case '5': mode = 1; Serial.println("Chế độ Auto");
      case '6': mode = 0; stopMotors(); Serial.println("Chế độ Thủ Công"); break; // Chỉ đổi mode, không điều khiển
